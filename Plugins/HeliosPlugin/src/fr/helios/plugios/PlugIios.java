...
import fr.helios.plugios.listener.FactionListener;
import fr.helios.plugios.listener.PlugiosListener;
import fr.helios.plugios.util.EffectBlood;
import fr.helios.plugios.util.EventCustom;
...
public class PlugIios extends JavaPlugin implements Listener
{
    ...
    public void onEnable()
    {
        ...
        pm.registerEvents(new EventCustom(), this);
