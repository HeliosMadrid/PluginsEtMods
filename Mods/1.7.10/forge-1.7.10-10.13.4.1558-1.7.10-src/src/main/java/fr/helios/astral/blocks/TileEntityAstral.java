...
public class TileEntityAstral extends TileEntity implements IInventory
{
    ...
    public void updateEntity()
    {
        ...
        if(!this.worldObj.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + this.xCoord + this.yCoord + this.zCoord) % 200 == 0)
        {
            ...
            while(iterator.hasNext())
            {
                ...
                if(entityplayer.openContainer instanceof ContainerAstres)
                {
                    IInventory iinventory = ((ContainerAstres)entityplayer.openContainer).getTileAstral(); 
    ...
    {
        return this.hasCustomInventoryName() ? this.customName : "tile.astres"; 
    }
