...
import fr.helios.astral.utils.EnchantementAstral;
import fr.helios.astral.utils.GuiHandlerAstral;
import fr.helios.astral.utils.event.EnchantementAstralManager;
import fr.helios.astral.utils.event.EntityEventHandler;
import fr.helios.astral.utils.event.LivingEventHandler;
import fr.helios.astral.utils.event.PlayerEventHandler;
//import fr.helios.astral.utils.generation.BiomeListAstral;
import fr.helios.astral.utils.generation.StructureGenerator;
import fr.helios.astral.utils.generation.WorldGeneration;
//import fr.helios.astral.utils.generation.WorldTypeAstral;
...
{   
    public static Enchantment enchantAstral;
    ...
    {
        enchantAstral = new EnchantementAstral().setName("enchantAstral");
    ...
    public void init(FMLInitializationEvent event)
    {
        ...
        MinecraftForge.EVENT_BUS.register(new EnchantementAstralManager());
    ...
    {
      //  BiomeListAstral.worldTypeAstral = new WorldTypeAstral();
    }
}
